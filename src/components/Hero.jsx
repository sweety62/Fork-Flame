    ...
    <div id="home" className="relative h-screen bg-cover w-full bg-center" style={{ backgroundImage: `url('${assets.heroImg}')` }}>
      ...
      <div className="container mx-auto px-6 h-full flex items-center z-10 relative">
        <div className="text-white max-w-2xl">
          ...
          <a className="bg-primary hover:bg-red-800 text-white font-bold px-8 py-3 rounded-full cursor-pointer transition duration-300 transform hover:scale-105" href="#reservation">
            Book a Table
          </a>
        </div>
      </div>
